...
export function AdminAppShell({
  ...
  return (
    <div className="flex h-dvh min-h-0 max-h-dvh flex-col overflow-hidden bg-brand-shell-bg text-brand-body">
        ...
        <div className="relative mx-auto flex w-full max-w-[1600px] items-center justify-between gap-3 md:gap-4">
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2 md:gap-3">
            ...
            <NotificationBell
              ...
              managePushHref="/admin/settings/profile"
            />
      ...
      <div
        className="flex min-h-0 flex-1 touch-pan-y flex-col overflow-y-auto overflow-x-hidden overscroll-y-contain pt-14 pb-[calc(5rem+env(safe-area-inset-bottom,0px))] md:pb-6 md:pt-16"

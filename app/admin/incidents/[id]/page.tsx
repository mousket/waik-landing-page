...
import { ArrowLeft, Send, Sparkles, Brain, Lightbulb, Target } from "lucide-react"
      ...
      <div className="space-y-6 relative max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
              <div>
                ...
                <p className="font-medium">
                  {incident.residentName} <span className="text-muted-foreground">(Room {incident.residentRoom})</span>
                </p>
              </div>
              <div>
        ...
        <Card className="border-primary/20 bg-white shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Review staff responses and ask follow-up questions</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {incident.questions.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-4">No questions yet</p>
            ) : (
              incident.questions.map((question, index) => (
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={3}
              />
              <Button onClick={sendQuestion} disabled={submitting || !newQuestion.trim()} className="w-full sm:w-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {/* Vercel AI Placeholders */}
          <Card className="border-accent/20 bg-white shadow-md">
            <CardHeader>
              <div className="flex items-center gap-2">
                <Sparkles className="h-5 w-5 text-accent" />
                <CardTitle className="text-base">Incident Summary (Sample)</CardTitle>
              </div>
          ...
          <Card className="border-accent/20 lg:col-span-2 bg-white shadow-md">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">Incident Insights (Sample)</CardTitle>
              </div>
          ...
          <Card className="border-accent/20 bg-white shadow-md">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">Incident Recommendations (Sample)</CardTitle>
              </div>
          ...
          <Card className="border-accent/20 bg-white shadow-md">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">Incident Actions (Sample)</CardTitle>
              </div>
